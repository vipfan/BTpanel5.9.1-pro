...
wget -O acme.sh https://raw.githubusercontent.com/vipfan/BTpanel5.9.1-pro/master/install/acme.sh -T 5
...
if [ ! -f $dns_bt ];then
	wget -O $dns_bt https://raw.githubusercontent.com/vipfan/BTpanel5.9.1-pro/master/install/dns_bt.sh -T 5
fi
